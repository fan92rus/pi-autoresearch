...
**Floor detection untried-ideas guard.** Floor detection now checks `ideas.md` before claiming a structural limit: if ≥2 untried ideas remain, it downgrades to a nudge ("try the ideas before concluding the limit is structural") instead of the full floor-reached block. This is consistent with the finalize trigger's untried-ideas check.
